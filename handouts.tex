...
\begin{document}
    ...
    \begin{figure}[htb]
        \centering
        \includegraphics[width=6.5in]{vsepr.jpg}
    \end{figure}
    \pagebreak
    ...
    \begin{center}\includegraphics[width=1.5in]{waterxyz.png} \includegraphics[width=2in]{ammoniaxyz.png}\end{center}
    \pagebreak
    ...
    \begin{center}\includegraphics[width=2in]{enantiomers.png}\end{center}

    \begin{figure}[htbp]
        \centering
        \includegraphics[width=6in]{chiral.jpg}
    \end{figure}
\end{document}